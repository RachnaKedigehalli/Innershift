...
const BaseLineCheckpoint = ({ route, navigation }) => {
  ...
  const [baselineCheckpointQuestion, setBaselineCheckpointQuestion] = useState(
      ...
      >
        ...
        <CustomButton
          ...
          onPress={async () => {
            ...
            // register()
            // console.log("firstName in baseline: ", firstName);
            // console.log("lastName in baseline: ", lastName);
            await register(
              email,
              firstName,
              lastName,
